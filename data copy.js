var window_categories =[
    ...
    {window:'contracts',code:'RSC', text:'Retail Sales Contract', approval:'ONESTEP',fields:[
        {variable:'name',required:'true'},
        {variable:'address',required:'true'},
        {variable:'tin',required:'false'},
    ]},
    {
        window:'dynamics',code:'METERING', text:'Monthly Metering Data', approval:'ONESTEP',
        filter:'sin',fields:[
            {variable:'metering_energy',required:'true',active:'true'},
    ...
    },
    {
        ...
        filter:'wesm_bid',fields:[
            ...
            {variable:'dwsa_dec_price',required:'true',active:'true'},
            {variable:'dwsa_metering_base',required:'true',active:'true'},
            {variable:'dwsa_metering_price',required:'true',active:'true'},
            {variable:'dwsa_supply_base',required:'true',active:'true'},
            {variable:'dwsa_supply_price',required:'true',active:'true'},
            {variable:'dwsa_pfa_base',required:'true',active:'true'},
    ...
    {
        window:'dynamics',code:'WESM_STL', text:'WESM Settlement Data', approval:'ONESTEP',
        filter:'sin',fields:[
            {variable:'line_rental',required:'true',active:'true'},
        ]
    },
    {
...
var variables = [
    ...
    {category:'determinants',code:'det_metering_energy',type:'number',text:'Energy',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'determinants',code:'det_metering_demand',type:'number',text:'Demand',description:'',active:'active',rounding:'kW',unit:'kW'},
    

    {category:'inputs',code:'genrate',type:'number',text:'Generation Rate',description:'',active:'active',rounding:'Php/kW',unit:'Php/kW'},  
    {category:'inputs',code:'genrateexcc',type:'number',text:'Generation Rate in exceess of CC',description:'',active:'active',rounding:'Php/kW',unit:'Php/kW'},    
    {category:'inputs',code:'metering_energy',type:'number',text:'Energy',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'metering_demand',type:'number',text:'Demand',description:'',active:'active',rounding:'kW',unit:'kW'},
    {category:'inputs',code:'energy_base',type:'number',text:'Energy Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'energy_exc',type:'number',text:'Energy Excess',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'line_rental',type:'number',text:'Line Rental',description:'',active:'active',rounding:'php',unit:'Php'},
   
    {category:'inputs',code:'dwsa_ddc_base',type:'number',text:'Distribution Demand Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ddc_price',type:'number',text:'Distribution Demand Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_dec_base',type:'number',text:'Distribution Energy Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_dec_price',type:'number',text:'Distribution Energy Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_metering_base',type:'number',text:'Metering Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_metering_price',type:'number',text:'Metering Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_supply_base',type:'number',text:'Supply Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_supply_price',type:'number',text:'Supply Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_pfa_base',type:'number',text:'Power Factor Adjustment Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_pfa_price',type:'number',text:'Power Factor Adjustment Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_dtru_base',type:'number',text:'Distribution Rate True Up Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_dtru_price',type:'number',text:'Distribution Rate True Up Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},

    {category:'inputs',code:'dwsa_ilprec_base',type:'number',text:'ILP Recovery Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ilprec_price',type:'number',text:'ILP Recovery Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_gour_base',type:'number',text:'GOUR Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_gour_price',type:'number',text:'GOUR Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_gramiceradaa_base',type:'number',text:'GRAM/ICERA/DAA Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_gramiceradaa_price',type:'number',text:'GRAM/ICERA/DAA Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_acrmrec_base',type:'number',text:'ACRM Recovery Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_acrmrec_price',type:'number',text:'ACRM Recovery Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    
    {category:'inputs',code:'dwsa_transdemand_base',type:'number',text:'Transmission Demand Base',description:'',active:'active',rounding:'kW',unit:'kW'},
    {category:'inputs',code:'dwsa_transdemand_price',type:'number',text:'Transmission Demand Price',description:'',active:'active',rounding:'Php/kW',unit:'Php/kW'},
    {category:'inputs',code:'dwsa_transenergy_base',type:'number',text:'Transmission Energy Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_transenergy_price',type:'number',text:'Transmission Energy Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    
    {category:'inputs',code:'dwsa_systemloss_base',type:'number',text:'System Loss Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_systemloss_price',type:'number',text:'System Loss Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
   
    {category:'inputs',code:'dwsa_reinvestcapex_base',type:'number',text:'Reinvestment fund for sustainable capex Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_reinvestcapex_price',type:'number',text:'Reinvestment fund for sustainable capex Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
   
    {category:'inputs',code:'dwsa_subslifeline_base',type:'number',text:'Lifeline Subsidy Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_subslifeline_price',type:'number',text:'Lifeline Subsidy Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_subsseniorcit_base',type:'number',text:'Senior Citicen Subsidy Charge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_subsseniorcit_price',type:'number',text:'Senior Citicen Subsidy Charge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_substrac_base',type:'number',text:'TRAC Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_substrac_price',type:'number',text:'TRAC Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_pfdiscsurg_base',type:'number',text:'Power Factor Discount/Surcharge Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_pfdiscsurg_price',type:'number',text:'Power Factor Discount/Surcharge Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    
    {category:'inputs',code:'dwsa_localfranctax_base',type:'number',text:'Local Franchise Tax Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_localfranctax_price',type:'number',text:'Local Franchise Tax Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_realproptax_base',type:'number',text:'Real Property Tax Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_realproptax_price',type:'number',text:'Real Property Tax Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    
    {category:'inputs',code:'dwsa_ucmissionary_base',type:'number',text:'Missionary Electrification Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ucmissionary_price',type:'number',text:'Missionary Electrification Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_ucenvshare_base',type:'number',text:'Environmental Share Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ucenvshare_price',type:'number',text:'Environmental Share Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_ucnpcstrandedcost_base',type:'number',text:'NPC Stranded Contract Costs Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ucnpcstrandedcost_price',type:'number',text:'NPC Stranded Contract Costs Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_ucnpcstrandeddebt_base',type:'number',text:'NPC Stranded Debt Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    {category:'inputs',code:'dwsa_ucnpcstrandeddebt_price',type:'number',text:'NPC Stranded Debt Price',description:'',active:'active',rounding:'Php/kWh',unit:'Php/kWh'},
    {category:'inputs',code:'dwsa_ucdustrandedcost_base',type:'number',text:'DU Stranded Contract Cost Base',description:'',active:'active',rounding:'kWh',unit:'kWh'},
    ...
    {category:'charges',code:'gencharge',type:'number',text:'Generation Charge',description:'',active:'active',base_rounding:'kWh',base_unit:'kWh',price_rounding:'Php/kWh',amount_rounding:'php'},
    {category:'charges',code:'genchargeexcc',type:'number',text:'Generation Charge in Excess of CC',description:'',active:'active',base_rounding:'kWh',base_unit:'kWh',price_rounding:'Php/kWh',amount_rounding:'php'},
    {category:'charges',code:'linerentalcharge',type:'number',text:'Line Rental',description:'',active:'active',base_rounding:'php',base_unit:'Php',price_rounding:'php',amount_rounding:'php'},
...
var variable_domain_codes = [
    ...
    {variable:'sin',code:'200205740103'},
]

var rounding_rules =[
    {code:'kWh',text:'kWh Rounding',decimal_place:7,description:'',},
    {code:'php',text:'Php Amounts Rounding',decimal_place:2,description:'',},
    {code:'Php/kWh',text:'Rates Rounding',decimal_place:4,description:'',},
    {code:'Php/kW',text:'Rates Rounding',decimal_place:4,description:'',},
...
contracts = [
    ...
    {category:'RSC',code:'RSC-GEN01-ALPDC-001',seller:'GEN01',buyer:'ALPDC'},
]

contract_update_trans = [
    {
        contract:'RSC-GEN01-ALPDC-001',period_from:'2023-01',period_to:'2033-12',create_by:'MKTG', create_time:'2022-12-15 00:00', 
        status:[ 
...
party_update_trans = [
    {
        party:'ALPDC',owned:'false',create_by:'MKTG', create_time:'2022-12-15 00:00', 
        status:[{status:'approved',sub_status:'',update_by:'MKTGMNGR',update_time:'2023-01-01 00:00',remarks:''},],
        texts:[
            {variable:'name',value:'Anonas LRT Property and Development Corporation'},
            {variable:'address',value:'65 Industria St., Bagumbayan Quezon City'},
            {variable:'tin',value:'008-013-282-000'},
        ],numbers:[],codes:[ ],
    }, 
    {
    ...
    filters:[
        {
            ...
            texts:[],
            numbers:[
                {variable:'metering_energy',value:554623.93},
    ...
    filters:[
        {
            ...
            texts:[],
            numbers:[
                {variable:'dwsa_ddc_base',value:1159.76},
                {variable:'dwsa_ddc_price',value:178.85},
                {variable:'dwsa_dec_base',value:553955},
                {variable:'dwsa_dec_price',value:0.0502},
                {variable:'dwsa_metering_base',value:1},
                {variable:'dwsa_metering_price',value:11823.21},
                {variable:'dwsa_supply_base',value:1},
                {variable:'dwsa_supply_price',value:12460.82},
                {variable:'dwsa_pfa_base',value:235231.62},
...
var billing_templates =[
    ...
    versions:[
        {version_number:0,status:'draft',remarks:'',create_by:'user',create_time:'2024-02-02 00:00',
        item_groups:[
    ...
    {code:'RETAIL_MERALCO',description:'Retail MERALCO Template',
        versions:[
            {version_number:0,status:'active',remarks:'',create_by:'user',create_time:'2024-01-01 00:00',
                item_groups:[
                    {index:1,type:'determinant',text:'Metering Information',internal:'false',items:[
...
var billing_setup = [
    {
        code:'RETAIL_MERALCO',description:'',template:'RETAIL_MERALCO',finance_scheme_buyer:'',finance_scheme_seller:'RETAIL_MERALCO',
...
var contract_billing_setup =[
    {contract:'RSC-GEN01-ALPDC-001',period_start:'202101',setup:'RETAIL_MERALCO'},
